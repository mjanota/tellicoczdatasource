...
sub html2perl {
    ...
    #     )->parent()
    # ) if $content->look_down(_tag => 'td', class => 'binfo_hard', sub { $_[0]->as_trimmed_text =~ /Rok vyd/ });
...
sub get_pub_year {
    my ($h, $pmore) = @_;
    $h->{pub_year} = $pmore->look_down(_tag => 'span', itemprop => 'datePublished')->as_trimmed_text
        if $pmore->look_down(_tag => 'span', itemprop => 'datePublished');
}

sub get_edition {
    my ($h, $pmore) = @_;
    $h->{edice} = $pmore->look_down(_tag => 'a', itemprop => 'BookEdition')->as_trimmed_text
        if $pmore->look_down(_tag => 'a', itemprop => 'bookEdition');
}

sub get_isbn {
    my ($h, $pmore) = @_;
    $$h{isbn} = $pmore->look_down(_tag => 'span', itemprop => 'isbn')->as_trimmed_text
        if $pmore->look_down(_tag => 'span', itemprop => 'isbn');
}
...
sub perl2xml {
    ...
    $out->emptyTag(
        "field",
        flags    => "3",
        title    => encode_utf8("Název originálu"),
        category => encode_utf8("Obecné"),
        format   => "4",
        type     => "1",
    ...
    $out->emptyTag(
        "field",
        flags    => "0",
        title    => encode_utf8("Žánr"),
        category => encode_utf8("Obecné"),
        allowed  => encode_utf8(
            "Román;Novela;Povídky;Epos;Legenda;Básně;Divadelní hra;Pohádka;Paměti;Kronika;Deníky;Dopisy;Rozhovor;Literatura faktu;Esej;Technická literatura;Časopis;Dějiny"
        ),
        format => "4",
        type   => "3",
        name   => encode_utf8("žánr")
    );
    $out->emptyTag(
        "field",
        flags    => "0",
        title    => encode_utf8("Číslo svazku"),
        category => encode_utf8("Obecné"),
        format   => "4",
        type     => "1",
        name     => encode_utf8("číslo-svazku")
    );
    $out->emptyTag(
        "field",
        flags    => "1",
        title    => encode_utf8("Vydání"),
        category => encode_utf8("Publikování"),
        format   => "0",
        type     => "6",
        name     => "edition"
    ...
    $out->emptyTag(
        "field",
        flags    => "3",
        title    => encode_utf8("Rok copyrightu"),
        category => encode_utf8("Publikování"),
        format   => "4",
        type     => "6",
        name     => "cr_year"
    ...
    $out->emptyTag(
        "field",
        flags       => "0",
        title       => encode_utf8("ISBN č. "),
        category    => encode_utf8("Publikování"),
        format      => "4",
        type        => "1",
        name        => "isbn",
        description => encode_utf8("Mezinárodní standardní knižní číslo")
    );
    $out->emptyTag(
        "field",
        flags    => "2",
        title    => encode_utf8("Vazba"),
        category => encode_utf8("Publikování"),
        allowed  => encode_utf8(
            "E-Book;Paperback;Žurnál;Časopis;Velký paperback;Vázaná;Brožovaná;Pevná vazba;vázaná;brožovaná"
        ),
        format => "4",
        type   => "3",
        name   => "binding"
    ...
    $out->emptyTag(
        "field",
        flags    => "7",
        title    => encode_utf8("Jazyk originálu"),
        category => encode_utf8("Publikování"),
        format   => "4",
        type     => "1",
        name     => "language"
    ...
    $out->emptyTag(
        "field",
        flags    => "2",
        title    => encode_utf8("Datum nabytí"),
        category => encode_utf8("Osobní"),
        format   => "3",
        type     => "12",
        name     => encode_utf8("datum-nabytí")
    );
    $out->emptyTag(
        "field",
        flags    => "0",
        title    => encode_utf8("Datum pozbytí"),
        category => encode_utf8("Osobní"),
        format   => "3",
        type     => "12",
        name     => encode_utf8("datum-pozbytí")
    );
    $out->emptyTag(
        "field",
        flags    => "6",
        title    => encode_utf8("Knihkupectví"),
        category => encode_utf8("Osobní"),
        format   => "4",
        type     => "1",
        name     => encode_utf8("knihkupectví")
    );
    $out->emptyTag(
        "field",
        flags    => "0",
        title    => encode_utf8("Stav"),
        category => encode_utf8("Osobní"),
        allowed  => encode_utf8("Sleva;Použitá;Nová;Antikvariát;Nový"),
        format   => "4",
        type     => "3",
        name     => "condition"
    );
    ...
    $out->emptyTag(
        "field",
        flags    => "3",
        title    => encode_utf8("Přečtená"),
        category => encode_utf8("Osobní"),
        format   => "4",
        type     => "1",
        name     => encode_utf8("přečtená")
    );
    $out->startTag(
        "field",
        flags    => "2",
        title    => encode_utf8("Hodnocení"),
        category => encode_utf8("Osobní"),
        format   => "4",
        type     => "14",
        name     => "rating"
    ...
    $out->emptyTag(
        "field",
        flags    => "4",
        title    => encode_utf8("Umístění"),
        category => encode_utf8("Osobní"),
        format   => "4",
        type     => "1",
        name     => encode_utf8("umístění")
    );
    $out->startTag(
        "field",
        flags    => "1",
        title    => encode_utf8("Hlavní postavy"),
        category => encode_utf8("Hlavní postavy"),
        format   => "4",
        type     => "8",
        name     => encode_utf8("hlavní-postavy")
    );
    ...
    $out->emptyTag(
        "field",
        flags    => "0",
        title    => encode_utf8("Téma"),
        category => encode_utf8("Téma"),
        format   => "4",
        type     => "2",
        name     => "comments"
    );
    $out->emptyTag(
        "field",
        flags    => "0",
        title    => encode_utf8("Přední obálka"),
        category => encode_utf8("Přední obálka"),
        format   => "4",
        type     => "10",
        name     => "cover"
    );
